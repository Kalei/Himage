...
if (isset($_GET['action'])) {
     if ($_REQUEST['action'] == "rate" && isset($_REQUEST['id_photo']) && isset($_REQUEST['rate_value'])) {
          ...
          if ($photo != false) {
               ...
               echo json_encode(array("photo" => array($list_champs['id_photos'] => $photo->{$list_champs['id_photos'] }, $list_champs['titre'] => $photo->{$list_champs['titre'] }, $list_champs['nom'] => $photo->{$list_champs['nom'] }, $list_champs['description'] => $photo->{$list_champs['description'] },
          ...
          $photo = photosTable::getPhotoById($_REQUEST['id_photo']);
          if ($photo != false) {
