...
class CustomUploadHandler extends UploadHandler {
     ...
     protected function handle_form_data($file, $index) {
          ...
          $file->recadrage_type = (!empty($_REQUEST['recadrage_type'])) ? $_REQUEST['recadrage_type'][$index] : $crop_or_canvas;
          ...
          if (empty($file->error)) {
               ...
               try {
                    ...
                    foreach ($res as $row) {
                         ...
                         $file->title = utf8_encode($row[$list_champs['titre']]);
                         $file->description = utf8_encode($row[$list_champs['description']]);
